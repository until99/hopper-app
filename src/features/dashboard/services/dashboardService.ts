...
export const dashboardService = {
     ...
     */
    async fetchGroupDashboards(groupId: string): Promise<DashboardsResponse> {
        const response = await api.get<Dashboard[]>(`/app/groups/${groupId}/dashboards`);
     ...
     */
    async fetchDashboardDetails(groupId: string, dashboardId: string): Promise<any> {
     ...
     * Deleta um dashboard
     */
    async deleteDashboard(dashboardId: string, groupId: string, datasetId: string): Promise<void> {
