        ...
        return (
            <Card>
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">Get started by creating a new group</p>
                </div>
            </Card>
        );
    }
                            ...
                            <TableCell>
                                <div className="flex items-center justify-end gap-2">
                                    ...
                                    <Link to={`/admin/groups/${group.id}/users`}>
                                        <Button variant="ghost" size="sm" title="View users">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <Link to={`/admin/groups/${group.id}/dashboards`}>
                                        <Button variant="ghost" size="sm" title="View dashboards">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
