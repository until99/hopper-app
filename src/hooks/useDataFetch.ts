    ...
    const fetchDashboards = async (force = false) => {
        ...
        const fetchFn = async () => {
            ...
            try {
                ...
                const errorMessage = error.response?.data?.message || error.message || 'Failed to fetch dashboards';
                setDashboardsState({
                    loading: false,
                    error: errorMessage,
                });
    ...
    const fetchPipelines = async (force = false) => {
        ...
        const fetchFn = async () => {
            ...
            try {
                ...
                const errorMessage = error.response?.data?.message || error.message || 'Failed to fetch pipelines';
                setPipelinesState({
                    loading: false,
                    error: errorMessage,
                });
